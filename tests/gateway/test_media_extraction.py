...
""",
    ...
    def test_gateway_auto_append_keeps_fish_voice_design_previews(self):
        """Fish voice-design candidates are delivered even if omitted from prose."""
        from gateway.run import _collect_auto_append_media_tags
        ...
        messages = [
            {
                ...
                "tool_calls": [
                    {
                        "id": "call_design",
                        "function": {"name": "fishaudio_voice_design_preview"},
                    }
                ],
            },
            {
                ...
                "content": (
                    ...
                    '{"preview_handle": "fishpreview_safe", '
                    '"media": "MEDIA:/workspace/artifacts/fishaudio-design-previews/candidate.wav"}]}'
                ),
            },
        ]
        ...
        tags, voice = _collect_auto_append_media_tags(messages, history_offset=0)
        assert tags == [
            "MEDIA:/workspace/artifacts/fishaudio-design-previews/candidate.wav"
        ]
        assert voice is False
