...
#
# Provider packages (anthropic, bedrock, azure-identity, edge-tts) are included
...
RUN touch ./README.md
RUN uv sync --frozen --no-install-project --extra all --extra messaging --extra anthropic --extra bedrock --extra azure-identity --extra edge-tts --extra hindsight --extra matrix
