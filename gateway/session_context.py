...
_SESSION_USER_TEXT: ContextVar = ContextVar("HERMES_SESSION_USER_TEXT", default=_UNSET)
...
_VAR_MAP = {
    ...
    "HERMES_SESSION_USER_TEXT": _SESSION_USER_TEXT,
...
def set_session_vars(
    ...
    tokens = [
        ...
        _SESSION_USER_TEXT.set(user_text),
