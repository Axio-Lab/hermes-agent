...
_SCHEMA_OVERRIDES: Dict[str, Dict[str, Any]] = {
    ...
    "stt.provider": {
        ...
        "options": ["local", "groq", "openai", "xai", "elevenlabs", "fishaudio"],
    },
    ...
    "stt.fishaudio.model": {
        "type": "select",
        "description": "Fish Audio beta whole-file ASR",
        "options": ["fish-audio-asr-beta"],
    },
    "display.skin": {
        "type": "select",
...
async def get_config(profile: Optional[str] = None):
    with _profile_scope(profile):
        config = _normalize_config_for_web(config_for_editor())
...
_PLATFORM_OVERRIDES: dict[str, dict[str, Any]] = {
    ...
    "slack": {
        "name": "Slack",
        "description": "Use Verxio from Slack via Socket Mode. Add allowed Slack member IDs so connected bots can respond.",
    ...
    "mattermost": {
        "name": "Mattermost",
        "description": "Connect Verxio to Mattermost channels and direct messages.",
    ...
    "matrix": {
        "name": "Matrix",
        "description": "Use Verxio in Matrix rooms and direct messages.",
    ...
    "dingtalk": {
        "name": "DingTalk",
        "description": "Connect Verxio to DingTalk groups (钉钉).",
    ...
    "feishu": {
        "name": "Feishu / Lark",
        "description": "Use Verxio inside Feishu / Lark.",
    ...
    "bluebubbles": {
        ...
        "description": "Use Verxio through iMessage via a BlueBubbles server.",
    ...
    "qqbot": {
        "name": "QQ Bot",
        "description": "Connect Verxio to a QQ Bot from the QQ Open Platform.",
    ...
    "yuanbao": {
        "name": "Yuanbao (元宝)",
        "description": "Connect Verxio to Tencent Yuanbao.",
        "docs_url": "",
        "required_env": (),
    },
    "api_server": {
...
def _whatsapp_platform_description() -> str:
    return "Use Verxio through the bundled WhatsApp bridge with QR-based auth."
...
def _messaging_platform_payload(
    ...
    if platform_id == "whatsapp":
        description = _whatsapp_platform_description()
