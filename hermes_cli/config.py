...
OPTIONAL_ENV_VARS = {
    ...
    "VOICE_TOOLS_OPENAI_KEY": {
        "description": "OpenAI API key for Whisper and GPT transcription plus OpenAI TTS. Create one from the OpenAI API keys page.",
    ...
    "GROQ_API_KEY": {
        "description": "Groq API key for fast, low-cost Whisper transcription. Create one from the Groq console API keys page.",
        "prompt": "Groq API key",
    ...
    "ELEVENLABS_API_KEY": {
        "description": "ElevenLabs API key for premium text-to-speech voices and Scribe transcription. Create one from ElevenLabs account settings.",
    ...
    "MISTRAL_API_KEY": {
        "description": "Mistral API key for Voxtral TTS and transcription. Create one from the Mistral console API keys page.",
