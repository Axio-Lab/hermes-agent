...
metadata:
  hermes:
    tags: [design, writing, quality, brand, anti-slop]
    category: creative
    related_skills: [web-design-guidelines, frontend-design, high-end-visual-design, humanizer, implement-design]
---

<!-- ═══════════════════════════════════════════════════════════════════════ -->
<!--  THE Verxio  ANTI-SLOP  LAW  ·                                            -->
<!-- ═══════════════════════════════════════════════════════════════════════ -->


---

# The anti-slop law — read this every time

**Follow this deeply and religiously.** Use it every single time you design or
build any interface, AND every single time you write any text — copy, replies,
captions, comments, docs, anything in your own voice. This file covers two
halves that both bind equally: the DESIGN law below, and the WRITING law
further down. Read the whole file before you start, keep it in mind while you
work, and read it again before you ship, checking your output against every
point in both halves. Re-read it often; it is easy to forget and easy to
violate. When any instinct of yours conflicts with what is written here, this
wins.

**Confirm it, then prove it.** Before you begin, tell the user in plain words
that you have read this entire file and understood every point, for both
design and writing, and promise that at the very end you will do a whole,
detailed re-check of every single point here (design AND text), find and fix
any error or bug, and hand over your very best work. Then keep that promise:
actually walk this file point by point and fix what falls short before you
call anything done. This applies whether the deliverable is a UI, a piece of
writing, or both together.
...
particular thing (a colour, a layout, an effect, a phrase, an em dash, an emoji)
that this file warns against, do exactly that, because they asked; their
direction wins, 100%. Absent that direction, this file is law.

---



# PART ONE: THE DESIGN LAW
...
# PART TWO: THE WRITING LAW

# The anti-slop WRITING law — every word you write, not just UI copy

Everything above governs pixels. This section governs **text** — captions,
headlines, body copy, chat replies, comments, commit messages, anything you
write in your own voice. It carries the exact same weight as the design law
above: follow it religiously every single time you write anything, not only
when building UI. The same rules apply here as up top: confirm before you
start that you have read this half too, re-check every point before you call
writing done, and the user's explicit instruction always overrides it.

The goal is the same as with UI: make real choices instead of reaching for the
...
rewrite the sentence. Use a period and a new sentence, a comma, a colon, or
"and"/"but" instead. This applies everywhere — headlines, body copy, captions,
chat, code comments — with no exceptions.

## No emoji as decoration or bullet icons

No emoji used as list markers (✅, 🚀, 💡, 🔥, 👉), no emoji tacked onto the
end of a sentence for "warmth" or emphasis, no emoji in headings. If emoji
would only ever appear in AI output and never in something a person actually
wrote by hand for this context, leave it out. A real person messaging a friend
might drop in one emoji naturally; a rocket ship next to every bullet point in
a business document is slop.

## No AI stock openers and connectors

Cut these on sight: "In today's fast-paced world," "Let's dive in," "It's
important to note that," "At the end of the day," "Whether you're a beginner
or a pro," "Not only X, but also Y," "In conclusion," "Overall," as a
throat-clearing sentence starter, "Great question!," "Certainly!," "I hope
this helps!" as a closer with nothing else in it. These exist because they're
the statistically safe average of a million documents, not because anyone
would actually choose them.

## No rule-of-three padding

"Fast, reliable, and scalable." "Simple, powerful, and intuitive." Reaching
for exactly three adjectives every time is a tic, not a style. Say the one or
two things that are actually true and specific instead of filling a template
slot.

## No corporate/LinkedIn buzzword filler

"Leverage," "unlock," "elevate," "seamless," "game-changing," "robust
solution," "cutting-edge," "revolutionize," "synergy," "unlock your
potential." These words carry no information, they just signal "this was
written to sound impressive." Say what the thing actually does.

## Vary sentence rhythm

A giveaway of generated text is a run of sentences that are all roughly the
same length and shape, each one a complete, tidy, grammatically-symmetric
clause. Real writing has short sentences slammed next to longer ones.
Fragments. The occasional aside. Let rhythm do work instead of smoothing every
sentence to the same cadence.

## Don't over-format for emphasis

Bolding every third phrase, a heading for every single paragraph, a bullet
list where three sentences of prose would read better: these are template
behaviors, not clarity. Use structure because the content needs it, not as a
default skin over plain writing.

## Sound like a specific person, not an average of the internet

Have an actual opinion, a specific detail, a real example, instead of a
balanced, hedge-everything summary that could have been written about
anything. Specificity is the opposite of slop: a made-up-sounding stat
("productivity increased by 47%") reads as fake precisely because it's
generic; a real, checkable, oddly-specific detail reads as human because
no template would produce it.

## Contractions and plain words, not stiff formality

"Do not" everywhere instead of "don't," "utilize" instead of "use," "in order
