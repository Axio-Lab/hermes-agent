...
description: "Generate a design library: components, styles, rules, and system structure."
...
Load when building or extending a Figma design system library. Trigger on: design library, component library in Figma, or design system in Figma.
