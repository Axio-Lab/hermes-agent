...
description: "Stronger frontend taste: composition, color, spacing, typography, and product presentation."
...
Load when frontend code works but visual quality needs stronger composition, color, spacing, or typography. Trigger on: improve taste, make it feel premium, better visual design, or less generic UI.
