...
description: "Turn Figma designs into code: components, layout, and visual matching."
...
Load when implementing UI from Figma with components, layout, and visual fidelity. Trigger on: implement design, Figma to code, build this screen, or match Figma specs.
