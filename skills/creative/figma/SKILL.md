---
name: figma
description: "Connect Figma work to agent workflows."
...
Load when Figma should connect to broader agent workflows. Trigger on: Figma workflow, Figma integration, or design handoff with Figma.
