...
```bash
python3 scripts/generate_report.py analysis.json outputs/first-customer-report.html
```

Absolute paths are also supported:

```bash
python3 /path/to/skills/research/finding-your-first-customer/scripts/generate_report.py /tmp/analysis.json /workspace/outputs/first-customer-report.html
```

Return a clickable absolute file link in the final response. Keep the JSON in a temporary or work directory unless the user asks for the raw data.
