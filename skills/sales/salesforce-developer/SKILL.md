...
description: "Salesforce development: logic, integrations, workflows, code, and admin tasks."
...
Load for Salesforce development, integrations, workflows, Apex, or admin tasks. Trigger on: Salesforce, Apex, Flow, SOQL, or Salesforce integration.
