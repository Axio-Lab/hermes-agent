---
name: browser
description: "Browser automation through the Browserbase ecosystem."
...
Load for browser tasks on Browserbase infrastructure. Trigger on: browserbase, cloud browser, stable browser automation, or remote browser session.
