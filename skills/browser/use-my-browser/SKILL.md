---
name: use-my-browser
description: "Work through the user's browser: pages, sessions, accounts, and real web actions."
platforms: [linux, macos, windows]
---

## When to use

Load when the agent should work through the user's existing browser session, accounts, or logged-in pages. Trigger on: use my browser, my session, logged-in site, or user's Chrome.
