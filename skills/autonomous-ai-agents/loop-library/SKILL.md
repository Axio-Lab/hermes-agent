...
metadata:
  hermes:
    tags: [loops, autonomous-agents, workflows, automation, iteration, verification]
    homepage: https://github.com/amdonatusprince/loop-library
    related_skills: [hermes-agent, karpathy-guidelines]
---
...
2. If the live catalog is unavailable, say that the Loop Library catalog could
 not be reached and ask whether the user wants to design a new bounded loop
 from scratch.
