    ...
    if allowed:
        ...
        access_idx = prompt_choice(
            ...
            [
                ...
                "Use DM pairing (unknown users request access, you approve in Verxio Messaging)",
        ...
        if access_idx == 0:
            ...
            print_info(
                "Approve requests in Verxio Web/Desktop > Messaging > WeCom > Pairing requests."
            )
        elif access_idx == 2:
            save_env_value("WECOM_DM_POLICY", "disabled")
            print_warning("Direct messages disabled.")
        else:
            print_info("Skipped — configure later in Verxio Web/Desktop > Messaging.")
